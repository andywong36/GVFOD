...
class RobotArmDynamics:
    _optimized_params = {
        ...
        "base_T": [110.87862925115707 * 1.35],
        "f1a": [1.4129360140919265e-7 / 1.35],
        "f1i": [0.000007626581489053154 / 1.35],
        "f1m": [0.0006634106668629292 / 1.35],
        "f2a": [0.00007716518208965043 / 1.35],
        "f2i": [0.00003074601549551998 / 1.35],
        "f2m": [0.00004162790299003434 / 1.35],
