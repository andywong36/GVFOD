...
if __name__ == "__main__":
    trials = MongoTrials(r'mongo://192.168.1.101:27017/hyperopt_db_failsim/jobs',
                         exp_key='test')
    space = {
        ...
        'I_a': hp.uniform('I_a', 0.2, 0.7),
        'l_1': hp.uniform('l_1', 0.126, 0.128),
        'l_2': hp.uniform('l_2', 0.1515, 0.1535),
        'l_3': hp.uniform('l_3', 0.177, 0.179),
        'slope1': hp.normal('slope1', -0.28, 0.1),
        'slope2': hp.normal('slope2', 0.21, 0.1),
        'EA': hp.loguniform('EA', 8, 12.5),
        'C_L': hp.lognormal('C_L', math.log(5.506), 0.01),
        'base_T': hp.uniform('base_T', 100, 180),
